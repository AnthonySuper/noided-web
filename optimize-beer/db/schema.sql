...
CREATE TYPE public.recipe_stage AS ENUM (
    'preparation',
    'mash',
    'sparge',
    'boil',
...
CREATE TABLE public.recipe_ingredients (
    ...
    amount_unit public.unit NOT NULL,
    amount_unit_category public.unit_category GENERATED ALWAYS AS (public.to_unit_category(amount_unit)) STORED NOT NULL,
    amount_normalized numeric(20,6) GENERATED ALWAYS AS (public.to_canonical_qty(amount, amount_unit)) STORED NOT NULL,
    addition_stage public.recipe_stage DEFAULT 'boil'::public.recipe_stage NOT NULL,
...
CREATE TABLE public.recipe_steps (
    ...
    step_stage public.recipe_stage DEFAULT 'mash'::public.recipe_stage NOT NULL,
...
ALTER TABLE public.recipe_steps ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.recipe_steps_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.recipes (
    ...
    name text NOT NULL COLLATE public.identifier,
    description text DEFAULT ''::text NOT NULL,
    batch_size numeric(20,6) DEFAULT 20.0 NOT NULL,
    batch_size_unit public.unit DEFAULT 'liter'::public.unit NOT NULL,
    batch_size_normalized numeric(20,6) GENERATED ALWAYS AS (public.to_canonical_qty(batch_size, batch_size_unit)) STORED NOT NULL,
    target_og numeric(6,3) DEFAULT 1.000 NOT NULL,
    target_fg numeric(6,3) DEFAULT 1.000 NOT NULL,
    target_abv numeric(4,2) DEFAULT 0.0 NOT NULL,
    target_ibu integer DEFAULT 0 NOT NULL,
    target_srm numeric(5,2) DEFAULT 0.0 NOT NULL,
    boil_time_minutes integer DEFAULT 60 NOT NULL,
    target_efficiency numeric(5,2) DEFAULT 75.0 NOT NULL,
    published_at timestamp with time zone,
    deleted_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT batch_size_must_be_volumetric CHECK ((public.to_unit_category(batch_size_unit) = 'volume'::public.unit_category))
);
...
ALTER TABLE ONLY public.recipes
    ADD CONSTRAINT recipes_have_unique_name_per_org UNIQUE (organization_id, name);
ALTER TABLE ONLY public.recipes
...
INSERT INTO schema_migrations (filename) VALUES ('202603200252_create_recipes_related_tables');
